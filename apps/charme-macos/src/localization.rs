...
localization_keys!(
    ...
    LoadingPmxRead,
    LoadingPmxParse,
    LoadingPmxTexturesProgress,
    LoadingPmxSelectionProgress,
    LoadingPmxSceneProgress,
    InspectingShader,
    ShaderError,
    ReflectionFailed,
    MaterialInspector,
    ...
    SaveProjectMessage,
    ChoosePmxMessage,
    ChoosePmxArchiveTitle,
    ChoosePmxArchiveMessage,
    PmxArchiveContainsNoModel,
    Import,
    Cancel,
    Save,
    DontSave,
